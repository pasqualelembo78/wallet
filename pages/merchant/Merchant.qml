...
Item {
    ...
    property int    minWidth: mobileMode ? 0 : 900
    property int    minHeight: mobileMode ? 0 : 600
    property int    qrCodeSize: mobileMode ? 160 : 220
    ...
    ColumnLayout {
        ...
        property int defaultMargin: mobileMode ? 10 : 50
        ...
        Item {
            Layout.preferredHeight: mobileMode ? 520 : 220
            ...
            Rectangle {
                ...
                anchors.top: parent.top
                height: 220
                width: mobileMode ? parent.width : (parent.width - qrImg.width) - 50
                radius: 5
            ...
            Rectangle {
                ...
                anchors.right: mobileMode ? undefined : parent.right
                anchors.top: mobileMode ? tracker.bottom : parent.top
                anchors.topMargin: mobileMode ? 10 : 0
                anchors.horizontalCenter: mobileMode ? parent.horizontalCenter : undefined
        ...
        Item {
            Layout.preferredHeight: mobileMode ? 60 : 40
            Layout.fillWidth: true

            Item {
                width: mobileMode ? parent.width : (parent.width - qrImg.width) - 50
                height: mobileMode ? 60 : 32
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    MevaCoinComponents.TextPlain {
                        ...
                        font.bold: false
                        color: "white"
                        text: qsTr("Amount to receive") + " (MVC)" + translationManager.emptyString
                        themeTransition: false
                    }
                    ...
                    MevaCoinComponents.TextPlain {
                        // @TODO: When we have MVC/USD rate avi. in the future.
                        visible: false
                        font.pixelSize: 14
                        font.bold: false
                        color: "white"
