...
Text {
    ...
    Rectangle {
        ...
        color: root.focus ? MevaCoinComponents.Style.titleBarButtonHoverColor : "transparent"
    }
    ...
    MevaCoinEffects.ColorTransition {
        ...
        targetObj: root
        duration: 750
        blackColor: root.themeTransitionBlackColor !== "" ? root.themeTransitionBlackColor : MevaCoinComponents.Style._b_defaultFontColor
        whiteColor: root.themeTransitionWhiteColor !== "" ? root.themeTransitionWhiteColor : MevaCoinComponents.Style._w_defaultFontColor
    }
