...
TextArea {
    ...
    states: [
        State {
            name: "black";
            when: textArea.themeTransition && MevaCoinComponents.Style.blackTheme
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorBlackTheme ? textArea.colorBlackTheme : MevaCoinComponents.Style._b_defaultFontColor
                }
            }
        }, State {
            name: "white";
            ...
            PropertyChanges {
                target: textArea
                color: {
                    return textArea.colorWhiteTheme ? textArea.colorWhiteTheme : MevaCoinComponents.Style._w_defaultFontColor
                }
            }
        }
    ]
