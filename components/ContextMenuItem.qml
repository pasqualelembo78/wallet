...
MenuItem {
    ...
    background: Rectangle {
        color: MevaCoinComponents.Style.buttonBackgroundColorDisabledHover
        opacity: 0
    ...
    contentItem: RowLayout {
        ...
        Text {
            ...
            color: MevaCoinComponents.Style.buttonTextColor
        ...
        Text {
            color: MevaCoinComponents.Style.blackTheme ? MevaCoinComponents.Style.buttonTextColor : MevaCoinComponents.Style.defaultFontColor
