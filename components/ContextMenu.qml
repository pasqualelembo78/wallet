...
MouseArea {
    ...
    Menu {
        ...
        background: Rectangle {
            border.color: MevaCoinComponents.Style.buttonBackgroundColorDisabledHover
            border.width: 1
            radius: 2
            color: MevaCoinComponents.Style.blackTheme ? MevaCoinComponents.Style.buttonBackgroundColorDisabled : "#E5E5E5"
        }
        ...
        MevaCoinComponents.ContextMenuItem {
