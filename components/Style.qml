...
QtObject {
    ...
    property string green: "#26B479"
    property string wookeyGreen: "#C9A020"  // MevaCoin gold
    property string wookeyDarkTeal: "#7A5C10"  // MevaCoin dark gold
    property string wookeyMidGreen: "#A88510"  // MevaCoin mid gold
    property string wookeyRed: "#FF3A5C"
    property string wookeyBackground: "#F6F6F6"
    property string mevacoinGrey: "#4C4C4C"
    ...
    property string _w_defaultFontColor: "#333333"
    property string _w_dimmedFontColor: "#9E9E9E"
    property string _w_lightGreyFontColor: "#515151"
    property string _w_errorColor: "#FF3A5C"
    ...
    property string _w_inputBorderColorActive: "#C9A020"
    ...
    property string _w_buttonBackgroundColor: "#C9A020"
    property string _w_buttonBackgroundColorHover: "#A88510"
    property string _w_buttonBackgroundColorDisabled: "#bbbbbb"
    property string _w_buttonBackgroundColorDisabledHover: "#D1D1D1"
    property string _w_buttonInlineBackgroundColor: "#FFF8E3"
    property string _w_buttonInlineBackgroundColorHover: "#F5E5A0"
    property string _w_buttonTextColor: "white"
    property string _w_buttonTextColorDisabled: "black"
    property string _w_buttonSecondaryBackgroundColor: "#FFF8E3"
    property string _w_buttonSecondaryBackgroundColorHover: "#F5E5A0"
    property string _w_buttonSecondaryTextColor: "#C9A020"
    ...
    property string _w_wizardBackgroundGradientStart: "#F5F3EE"
    property string _w_middlePanelBackgroundGradientStart: "#F5F3EE"
    property string _w_middlePanelBackgroundGradientStop: "#EDEBE3"
    property string _w_middlePanelBackgroundColor: "#F5F3EE"
    ...
    property string _w_menuButtonTextColor: "#333333"
    property string _w_menuButtonImageRightSource: "qrc:///images/right.svg"
    property string _w_menuButtonImageRightColorActive: "#C9A020"
    ...
    property string _w_inlineButtonTextColor: "#C9A020"
    property string _w_inlineButtonBorderColor: "#C9A020"
    ...
    property string _w_leftPanelBackgroundGradientStart: "#7A5C10"
    property string _w_leftPanelBackgroundGradientStop: "#C9A020"
    property string _w_historyHeaderTextColor: "#333333"
    property var _w_accountColors: ["#C9A020", "#C9A020", "#C9A020", "#C9A020", "#C9A020", "#C9A020", "#C9A020", "#C9A020", "#C9A020"]

    // Mobile properties
    property bool isMobile: typeof isAndroid !== "undefined" ? isAndroid : false
    property int mobileBottomBarHeight: 56
    property int mobileTouchMinHeight: 48
    property int mobileHeaderHeight: 64
    property real mobileFontScale: isMobile ? 1.1 : 1.0
    property string mobileBottomBarBackground: blackTheme ? "#1a1a1a" : "#f5f5f5"
    property string mobileBottomBarActive: blackTheme ? "#FA6800" : "#FA6800"
    property string mobileBottomBarInactive: blackTheme ? "#808080" : "#999999"
    property string mobileHeaderBackground: blackTheme ? "#1e1e1e" : "#ffffff"
