...
ColumnLayout {
    ...
    RowLayout {
        ...
        MevaCoinComponents.Label {
            color: lineEdit.inputHasFocus ? MevaCoinComponents.Style.defaultFontColor : MevaCoinComponents.Style.dimmedFontColor
            fontSize: 13
            text: (wordNumber + 1)
        ...
        MevaCoinComponents.TextPlain {
            ...
            color: wordsMatch ? (MevaCoinComponents.Style.blackTheme ? "#00FF00" : "#008000") : "#FF0000"
            themeTransition: false
            onTextChanged: {
    ...
    Rectangle {
        id: underLine
        color: lineEdit.inputHasFocus ? MevaCoinComponents.Style.defaultFontColor : MevaCoinComponents.Style.appWindowBorderColor
